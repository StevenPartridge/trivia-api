import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, JoinColumn, CreateDateColumn, UpdateDateColumn, getRepository } from 'typeorm';
...
export class UserAnswer {
  ...
  async getCorrectAnswer(): Promise<string | null> {
    ...
    const question = await questionRepository.findOneBy({ id: this.question_id });
